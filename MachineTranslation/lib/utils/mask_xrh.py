...
def create_target_look_ahead_mask(target, _null_target):
...
def create_masks(source, target, _null_source, _null_target):
    ...
    target_look_ahead_mask = create_target_look_ahead_mask(target, _null_target)

    return encoder_padding_mask, target_look_ahead_mask
