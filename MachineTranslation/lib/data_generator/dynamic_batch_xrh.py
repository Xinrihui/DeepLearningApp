...
ref:
1.https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/utils/data_reader.py
...
class Test:
    ...
    def test_batching_scheme(self):
        ...
        ret = batching_scheme(batch_size,max_length,min_length_bucket, length_bucket_step)

        print(ret['boundaries'])

        print(ret['batch_sizes'])

if __name__ == '__main__':

    test = Test()

    test.test_batching_scheme()
